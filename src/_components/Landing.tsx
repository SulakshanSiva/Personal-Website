  ...
  return (
    <div className="flex items-center flex-col text-center">
      ...
      <div className="flex flex-row items-center justify-around sm:justify-between w-full max-w-md mt-5">
        {/* Resume */}
        <a
          href="https://drive.google.com/file/d/1Pe3fHIkMBQ9pneqnu3tC7Cpq0oVbUbGo/view"
          target="_blank"
        ...
        <div className="flex flex-row space-x-2 sm:space-x-4">
          ...
          <a href='https://www.linkedin.com/in/sulakshansiva/' target="_blank"
            className="cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center hover:bg-[#FFD700] transition-colors duration-300">
          ...
          {/* Email */}
          <a href='mailto:sulakshansivak@gmail.com'
            className="cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center hover:bg-[#FFD700] transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-6 h-6">
